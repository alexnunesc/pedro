...
export default function App() {
  ...
  return (
    <div className="border-2 border-black p-2 container mx-auto max-w-[1341px] flex justify-center gap-1 flex-col xl:flex-row min-w-[430px]">
      {/* Lado Esquerdo */}
      <div className="border-2 border-black p-4 md:w-3/3 pr-4 mb-4 md:mb-0">
        ...
        <div className="border-2 border-black p-1 grid grid-cols-1 md1:grid-cols-2 md:grid-cols-1 gap-2 mb-4">
          {
      ...
      {/* Lado Direito */}
      <div className="border-2 border-black p-4 bg-white p-4 rounded-md shadow-md flex-col w-full lg:w-[30%] min-w-[433px]">
